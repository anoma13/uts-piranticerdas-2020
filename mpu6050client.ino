...
const char* ssid     = "gambiran";
const char* password = "haraptenang";

// REPLACE with your Domain name and URL path or IP address with path
const char* serverName = "http://192.168.1.6/piranticerdas/savedb.php";
...
void loop() {
  ...
  Gz = (double)GyroZ / GyroScaleFactor;
    ...
    String httpRequestData = String("Ax=") + String(Ax) + String("&Ay=") + String(Ay) + String("&Az=") + String(Az) + String("&Gx=") + String(Gx) + String("&Gy=") + String(Gy) + String("&Gz=") + String(Gz);
